...
import style from "./WebCareerPage_New3.module.scss"
//#region Component
import ImageSlideDialog from "../../Common/ImageSlideDialog"
import PortfolioCard_New2, { PortfolioData } from "./PortfolioCard_New2"
...
import MobileImg202 from "../../../Resource/mobile/work/002.jpg"
interface CardItem {
    title: string;
    content: string;
    imgSrc?: string;
...
function WebCareerPage() {
                ...
                <div className={`${style.layout} ${style.mobile}`}>
                    ...
                    <div className={style.content}>
                        ...
                        <div className={`${style.card} ${style.portfoilo}`}>
                            <PortfolioCard_New2 className={style.item} data={mobilePortfolio1} type="mobile" onClick={
                                () => {
                        ...
                        <div className={`${style.card} ${style.portfoilo}`}>
                            <PortfolioCard_New2 className={style.item} data={mobilePortfolio2} type="mobile" onClick={
                                () => {
                                    setImgPortfolioOpen(true)
                        ...
                        <div className={`${style.card} ${style.portfoilo}`}>
                            <PortfolioCard_New2 className={style.item} data={mobilePortfolio3} type="mobile" onClick={
                                () => {
                                    setImgPortfolioOpen(true)
    ...
    //             <div className={`${style.layout}`} style={{ marginBottom: "5px" }}>
    ...
    //                 } />
    //             </div>
    //             <div className={`${style.layout}`} style={{ marginTop: "5px" }}>
